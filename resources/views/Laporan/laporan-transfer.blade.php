  ...
  <div class="row">
    <div class="col">
      <div class="card card-primary card-outline">
        ...
        <form method="get" action="{{ url('Laporan/laporan-transfer')  }}" >
            ...
            <form class="form-group" action="{{ url('Laporan/cetak-laporanTransfer')  }}" method="GET" enctype="multipart/form-data" style="float: right">
              @csrf
