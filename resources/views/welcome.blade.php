...
*/
    ...
    <nav class="navbar navbar-expand-md navbar-light " style="height: 25px; background-color:#009688">
    <div class="container navbar">
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="btn btn-custom" style="color:#ffff;" href="{{ url('seller') }}" class="nav-link"><small>seller center</small></a>
          </li>
        </ul>
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            @if (Route::has('login'))
                        @auth
                        @role('admin')
                            <a href="{{ url('/dashboardAdmin') }}" class="nav-link" style="color:#ffff;"><small>Home</small></a>
                        @elserole('percetakan')
                        <a href="{{ url('/dashboardPercetakan') }}" class="nav-link" style="color:#ffff;"><small>Home</small></a>
                        @elserole('pelanggan')
                            <a href="{{ url('/home') }}" class="nav-link" style="color:#ffff;"><small>Home</small></a>
                        @endrole
                        @else
                            <a href="{{ route('login') }}" class="nav-link" style="color:#ffff;"><small>Log in</small></a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="nav-link" style="color:#ffff;"><small>Register</small></a>
                            @endif
                        @endauth
                    </div>
            @endif
...
<nav class="navbar navbar-expand-md navbar-light " style="height: 80px; background-color:#009688">
    <div class="container navbar">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <!-- SEARCH FORM -->
        <form class="col-6" action="/" method="GET">
...
<div class="content">
  <div class="container-fluid mt-3" style="max-width: 100%; align: center">
  <section id="produk" class="py-2 text-center bg-white ">
