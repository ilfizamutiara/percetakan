...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 11, 2022 at 01:43 PM
...
(36, 47, 8, 7, 3, 'Sedang', NULL, 120000),
(39, 40, 8, 10, 1, '1x1', NULL, 50000),
(40, 40, 9, 10, 1, '1x1', NULL, 50000),
(50, 47, 7, 7, 1, 'Sedang', NULL, 40000),
(51, 51, 7, 7, 1, '1x1', NULL, 250000),
(52, 28, 7, 9, 1, '1x1', NULL, 70000);
...
INSERT INTO `percetakan` (`id_percetakan`, `id_user`, `nama_toko`, `alamat_toko`, `no_telp`, `foto`, `created_at`, `updated_at`) VALUES
(7, 18, 'NR DIGITAL PRINTING', 'Jl. Diponegoro No. 25, VI Suku, Lubuk Sikarah, kota Solok', '085674635454', '20210923064415.jpg', '2021-08-27 08:54:05', '2021-08-27 08:54:05'),
(9, 22, 'TIGA PUTRA DIGITAL PRINTING', 'Jln. A. Yani No. 83 Kel. VI Suku Kec. Lubuk Sikarah Kota Solok', '082378918920', '20210923064258.jpg', '2021-09-10 06:30:53', '2021-09-10 06:30:53'),
(10, 23, 'Cemerlang Digital Printing', 'Jl. Diponegoro No. 44 Simpang Ambacang VI Suku kota Solok', '082341567854', '20211001045249.jpg', '2021-09-10 07:13:19', '2021-09-10 07:13:19'),
(11, 24, 'ZAKY PRINTING', 'Jl. Ir. Soekarno, VI Suku, Lubuk Sikarah, kota Solok, Sumatra Barat, 27317', '089756745455', '20201006_214149.jpg', '2021-09-13 16:02:56', '2021-09-13 16:02:56'),
(13, 34, 'Central Digital Printing', 'Jl. Dr. Hamka. No. 142 Kateka, Lubuk sikarah, Kota Solok, Sumatra Barat', '089734221245', '20210923064347.jpg', '2021-09-22 15:46:26', '2021-09-22 15:46:26'),
(17, 40, 'STARGRAF DIGITAL PRINTING', 'Jl. Prof. M. Yamin SH, Komplek Ruko Jaya (Pandang Ujung) Kelurahan, Ps. Pandan Air Mati, Tj. Harapan, Kota Solok, Sumatra Barat 27317', '082344368799', '20210923050913.jpg', '2021-09-23 05:09:13', '2021-09-23 05:09:13');
...
--
DELIMITER $$
CREATE TRIGGER `stokbarang` AFTER INSERT ON `pesanan` FOR EACH ROW BEGIN
...
INSERT INTO `rekening` (`id_rek`, `id_user`, `bank`, `no_rek`, `nama_pemilik`, `created_at`, `updated_at`) VALUES
(2, 1, 'BRI', '123938387346523', 'admin', '2021-11-18 09:28:00', '2021-11-18 09:28:00'),
(8, 22, 'BRI', '123938387346523', 'Rahmi', '2021-11-18 09:38:20', '2021-11-18 09:38:20'),
(13, 22, 'Mandiri', '5552637382', 'Mutiara', '2021-11-20 08:29:30', '2021-11-20 08:29:30'),
(14, 22, 'BNI', '5552637382', 'tiara', '2021-11-20 08:30:12', '2021-11-20 08:30:12');
...
(1, 'Belum bayar', '2021-10-22 05:17:53', '2021-10-22 05:17:53'),
(2, 'Dibayar', '2021-10-22 05:17:53', '2021-10-22 05:17:53'),
(3, 'Diproses', '2021-10-22 05:18:18', '2021-10-22 05:18:18'),
(4, 'Dikirim', '2021-10-22 05:18:18', '2021-10-22 05:18:18'),
(5, 'Diterima', '2021-10-22 05:18:49', '2021-10-22 05:18:49'),
(6, 'Selesai', '2021-10-22 05:18:49', '2021-10-22 05:18:49'),
(7, 'Dibatalkan\r\n', '2021-10-22 09:22:28', '2021-10-22 09:22:28');
...
INSERT INTO `uploads` (`id_upload`, `id_keranjang`, `name_file`, `extension`, `created_at`, `updated_at`) VALUES
(1, 37, '1640850253392.pdf', NULL, '2021-12-30 07:44:13', '2021-12-30 07:44:13'),
(2, 38, '1640850253392.pdf', NULL, '2021-12-30 07:44:14', '2021-12-30 07:44:14'),
(4, 36, '1641002431840.pdf', NULL, '2022-01-01 02:00:37', '2022-01-01 02:00:37'),
(5, 36, '1641009155907.pdf', NULL, '2022-01-01 03:52:35', '2022-01-01 03:52:35'),
(6, 36, '1641024444820.pdf', NULL, '2022-01-01 08:07:24', '2022-01-01 08:07:24'),
(7, 39, '1641024444820.pdf', NULL, '2022-01-01 08:07:24', '2022-01-01 08:07:24'),
(8, 40, '1641101455106.pdf', NULL, '2022-01-02 05:30:56', '2022-01-02 05:30:56'),
(9, 40, '1641103830208.pdf', NULL, '2022-01-02 06:10:30', '2022-01-02 06:10:30'),
(10, 40, '1641104028253.pdf', NULL, '2022-01-02 06:13:49', '2022-01-02 06:13:49'),
(11, 40, '1641215760569.pdf', NULL, '2022-01-03 13:16:00', '2022-01-03 13:16:00');
...
(1, 'admin', 'admin@gmail.com', NULL, NULL, NULL, 1, NULL, NULL, '$2y$10$W40r0g3zldLJk56qeL5WRudYIH/zr0d57aJZaXL/r2y4WumdT472i', NULL, '2021-08-19 02:06:21', '2021-08-19 02:06:21'),
(18, 'NR DIGITAL PRINTING', 'nrdigitalprinting@gmail.com', 32, 421, 27356, 2, '20210923064415.jpg', NULL, '$2y$10$dzfD5x7htIp/2AY.qTjEaeLyUo/013oOVFl8uaRMXbcb6klMhSeOm', NULL, '2021-08-27 01:54:05', '2021-09-10 00:05:15'),
(22, 'tigaputra', 'tigaputra1401@gmail.com', 32, 421, 27356, 2, '20210923064258.jpg', NULL, '$2y$10$31BDMa4FHLt946ok2NO01Ot9MBOIfEMWejK9h4W4A4w4uuOtBTBbi', NULL, '2021-09-09 23:30:53', '2021-11-04 21:56:42'),
(23, 'cdp', 'cemerlangdigital.1solok@gmail.com', 32, 421, 27356, 2, '20211001045249.jpg', NULL, '$2y$10$EsL10o1SpMR7/ENX9BjyguzR6eZBLSRdN4tK6FliHHAR.aJasXLMi', NULL, '2021-09-10 00:13:19', '2021-11-17 20:54:06'),
(24, 'ZAKY PRINTING', 'zakyprinting@gmail.com', 32, 421, 27356, 2, '20201006_214149.jpg', NULL, '$2y$10$0Zy0yJAgZYD5HS.PSeuJUOdqNaX2MUZ7wGZAS21kYWqTuVJM7eoNK', NULL, '2021-09-13 09:02:55', '2021-09-13 09:02:55'),
(27, 'Jisung1234', 'jisung@gmail.com', NULL, NULL, NULL, 3, NULL, NULL, '$2y$10$0jqsb9Mvq/oiL091Wa/4Ue/SlKkGEuezs/eCwtLqHmot3ML9wL6Ta', NULL, '2021-09-17 14:26:10', '2022-01-02 22:16:29'),
(34, 'Central Digital Printing', 'centraldigital@gmail.com', 32, 421, 27356, 2, '20210923064347.jpg', NULL, '$2y$10$YE5ZsjrGPJhAqFZZmu9BxeP0QGiQJPfZmWPnwTPBHwRGK.ur5Hrjq', NULL, '2021-09-22 08:46:26', '2021-09-22 08:46:26'),
(40, 'STARGRAF DIGITAL PRINTING', 'stargrafsolok@gmail.com', 32, 421, 27356, 2, '20210923050913.jpg', NULL, '$2y$10$qoLgqOUUVueN6FCehk7wy.HCqbocl7wWgrqjEJz2PVxpL.2o9mNRK', NULL, '2021-09-22 22:09:12', '2021-09-22 22:09:12'),
(42, 'register', 'ter@gmail.com', NULL, NULL, NULL, 2, NULL, NULL, '$2y$10$WXcRMalimZTVGmO.Slk9auHHuRda3MFCvu.RTaIcK./rt/pZs7btK', NULL, '2021-10-31 21:16:23', '2021-10-31 21:16:23'),
(43, 'fizaa', 'fizaa@gmail.com', NULL, NULL, NULL, 2, NULL, NULL, '$2y$10$MfJKwvtg3mrCvhgXg2lTQOzQNjZHIADKtIrV9EuD16vGaFEF63Nva', NULL, '2021-11-08 22:23:44', '2021-11-08 22:23:44'),
(46, 'markle', 'mark@gmail.com', 21, 1, NULL, 3, NULL, NULL, '$2y$10$znHjQJHRQmZKJdAgt6aoYuANQWFaTd0IKOz912FonK4HIus0Jbcv2', NULL, '2021-11-09 00:48:42', '2022-01-09 23:17:56'),
(48, 'cetak', 'cetak@gmail.com', NULL, NULL, NULL, 2, NULL, NULL, '$2y$10$WouweRxSQhEkSvvQY6M3y.KzsxS6DOJDKPEq1Ku0MR4.t5xOpIKY2', NULL, '2021-11-09 02:04:02', '2021-11-09 02:04:02'),
(54, 'ania', 'ani@gmail.com', NULL, NULL, 25163, 3, NULL, NULL, '$2y$10$q9SfqdRokQ.psr.Vr7Kzoek5vKIvmkZJgjPrj9HuQTIfLpIRxl4Xq', NULL, '2021-11-09 22:45:52', '2022-01-02 08:26:50'),
(55, 'sastra', 'sastra@gmail.com', 32, 318, NULL, 3, NULL, NULL, '$2y$10$u2bftygQ9Sgs83QQda6Qs.2bbdJU1QxBJevfV.kUdZ2NIWaMXu5LK', NULL, '2022-01-01 22:29:49', '2022-01-03 06:15:01');
...
--
ALTER TABLE `rekening`
  MODIFY `id_rek` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
ALTER TABLE `delivery`
  ...
  ADD CONSTRAINT `delivery_ibfk_2` FOREIGN KEY (`id_percetakan`) REFERENCES `percetakan` (`id_percetakan`);
...
ALTER TABLE `detail_pesanan`
  ...
  ADD CONSTRAINT `detail_pesanan_ibfk_2` FOREIGN KEY (`id_percetakan`) REFERENCES `percetakan` (`id_percetakan`),
  ADD CONSTRAINT `detail_pesanan_ibfk_3` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id_produk`);

--
-- Constraints for table `detail_produk`
--
ALTER TABLE `detail_produk`
  ADD CONSTRAINT `detail_produk_ibfk_1` FOREIGN KEY (`id_produk`) REFERENCES `detail_produk` (`id`);
...
ALTER TABLE `keranjang`
  ...
  ADD CONSTRAINT `keranjang_ibfk_2` FOREIGN KEY (`id_percetakan`) REFERENCES `percetakan` (`id_percetakan`),
...
--
ALTER TABLE `kota`
  ADD CONSTRAINT `kota_ibfk_1` FOREIGN KEY (`id_province`) REFERENCES `province` (`id_province`);
...
--
ALTER TABLE `percetakan`
  ADD CONSTRAINT `percetakan_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`);
...
ALTER TABLE `pesanan`
  ...
  ADD CONSTRAINT `pesanan_ibfk_4` FOREIGN KEY (`id_status_pesanan`) REFERENCES `status_pesanan` (`id`);
...
ALTER TABLE `users`
  ...
  ADD CONSTRAINT `users_ibfk_3` FOREIGN KEY (`id_province`) REFERENCES `province` (`id_province`),
  ADD CONSTRAINT `users_ibfk_4` FOREIGN KEY (`id_city`) REFERENCES `kota` (`id_city`);
COMMIT;
