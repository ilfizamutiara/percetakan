...
//Produk
Route::get('Produk', 'App\Http\Controllers\ProdukController@index')->name('Produk')->middleware('role:percetakan');
...
Route::get('Produk/delete/{id_produk}', 'App\Http\Controllers\ProdukController@destroy');
